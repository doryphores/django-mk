...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('app', ['King'])


    def backwards(self, orm):
        
        # Deleting model 'King'
        db.delete_table('app_king')
    ...
    models = {
        ...
        'app.king': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.Player']"}),
        ...
        'app.player': {
            ...
            'titles': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['app.Track']", 'through': "orm['app.King']", 'symmetrical': 'False'})
        },
        'app.playerhistory': {
        ...
        'app.track': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kings': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['app.Player']", 'through': "orm['app.King']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'})
        }
    }
